      ...
      <section id="home" className="pt-20 sm:pt-24 pb-8 sm:pb-12 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center space-y-6 sm:space-y-8 animate-slideInUp px-2">
            ...
            {/* Contact Telegram Button - Simple */}
            <div className="mt-8 flex justify-center px-4">
              <a
                href="https://t.me/+s9H7HD52UJ5lOWRk"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl font-bold text-white hover:scale-105 transition-transform shadow-xl shadow-blue-500/30 text-base sm:text-lg"
              >
